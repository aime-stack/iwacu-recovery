...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      href: "https://instagram.com/iwacurecoverycentre?igsh=MTE4b3ljZTBuamtqcw==",
      label: "Instagram",
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 0C5.373 0 0 5.373 0 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12 24 5.373 18.627 0 12 0z"/>
        </svg>
      ),
    },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 transition-all duration-1000 ${
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/" className="text-slate-300 hover:text-brand-primary transition-colors duration-300">Home</Link></li>
              <li><Link href="/about" className="text-slate-300 hover:text-brand-primary transition-colors duration-300">About Us</Link></li>
              <li><a href="#services" className="text-slate-300 hover:text-brand-primary transition-colors duration-300">Programs</a></li>
              <li><Link href="/contact" className="text-slate-300 hover:text-brand-primary transition-colors duration-300">Contact Us</Link></li>
              <li><a href="#sponsor" className="text-slate-300 hover:text-brand-primary transition-colors duration-300">Give Hope to a Life in Need</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-slate-300">
              <div className="flex items-start space-x-3">
                <div className="bg-brand-primary rounded-full p-1.5 flex-shrink-0 mt-0.5">📍</div>
                <div>KK 32 Avenue<br />Kigali, Rwanda<br /><span className="text-xs text-slate-400">Kicukiro-Karembure</span></div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-brand-primary rounded-full p-1.5 flex-shrink-0">📞</div>
                <div>
                  <a href="tel:+250788772489" className="hover:text-brand-primary transition-colors duration-300 font-medium">+250 788 772 489</a>
                  <p className="text-red-300 text-xs">Emergency 24/7</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-brand-primary rounded-full p-1.5 flex-shrink-0">📧</div>
                <div><a href="mailto:irecoverycentre17@gmail.com" className="hover:text-brand-primary transition-colors duration-300">irecoverycentre17@gmail.com</a></div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="bg-brand-primary rounded-full p-1.5 flex-shrink-0 mt-0.5">🕒</div>
                <div>Mon - Fri: 8:00 AM - 6:00 PM<br />Sat: 9:00 AM - 4:00 PM<br /><span className="text-red-300 font-medium text-xs">Emergency: 24/7</span></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`mt-8 p-4 bg-gradient-to-r from-slate-700 via-slate-800 to-slate-900 rounded-xl shadow-lg border border-slate-600/30 transition-all duration-1000 delay-400 ${
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4">
            <div className="flex items-center space-x-3">
              <div className="bg-brand-primary/20 rounded-full p-2">🚨</div>
              <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <a href="tel:+250788772489" className="bg-brand-primary text-white px-4 py-2 rounded-lg text-xs font-medium text-center hover:bg-blue-700 transition-all duration-300 hover:scale-105 shadow-md">📞 Call: +250 788 772 489</a>
              <a href="https://wa.me/250788772489" target="_blank" rel="noopener noreferrer" className="bg-green-600 text-white px-4 py-2 rounded-lg text-xs font-medium text-center hover:bg-green-700 transition-all duration-300 hover:scale-105 shadow-md">💬 WhatsApp</a>
            </div>
          </div>
        </div>
        ...
        <div className={`border-t border-slate-700 mt-8 pt-6 transition-all duration-1000 delay-200 ${
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-slate-400 text-sm mb-3 md:mb-0">© {currentYear} Iwacu Recovery Centre. All rights reserved.</div>
            <div className="flex space-x-6 text-sm">
              <Link href="/privacy" className="text-slate-400 hover:text-brand-primary transition-colors duration-300">Privacy Policy</Link>
              <Link href="/terms" className="text-slate-400 hover:text-brand-primary transition-colors duration-300">Terms of Service</Link>
              <Link href="/accessibility" className="text-slate-400 hover:text-brand-primary transition-colors duration-300">Accessibility</Link>
            </div>
          </div>
        </div>
      </div>
