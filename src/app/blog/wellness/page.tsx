...
import { wellnessTipsArticles } from '@/lib/articles';

export const metadata = {
  title: 'Wellness Tips | Iwacu Recovery Centre',
  description: 'Practical advice and strategies for maintaining mental health and supporting recovery.',
};

export default function WellnessPage() {
  const articles = wellnessTipsArticles;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">
            Wellness <span className="text-blue-500">Tips</span>
          </h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Practical advice and strategies for maintaining mental health and supporting recovery.
          </p>
        </div>
        ...
        {articles.length > 0 ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((article) => (
              <Link
                key={article.id}
                href={`/blog/wellness/${article.slug}`}
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-600">Check back soon for wellness tips!</p>
          </div>
        )}
      </div>
    </div>
