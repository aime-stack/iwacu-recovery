...
import { mentalHealthArticles } from '@/lib/articles';

export const metadata = {
  title: 'Mental Health Articles | Iwacu Recovery Centre',
  description: 'Explore insights on mindfulness, self-compassion, and mental wellness in recovery and healing.',
};

export default function MentalHealthPage() {
  const articles = mentalHealthArticles;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">
            Mental <span className="text-blue-500">Health</span>
          </h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Explore insights on mindfulness, self-compassion, and mental wellness in recovery and healing.
          </p>
        </div>
        ...
        {articles.length > 0 ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((article) => (
              <Link
                key={article.id}
                href={`/blog/mental-health/${article.slug}`}
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-600">Check back soon for mental health content!</p>
          </div>
        )}
      </div>
    </div>
