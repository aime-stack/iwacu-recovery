          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="admin@iwacu.com"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent text-gray-900 bg-white placeholder:text-gray-400 disabled:bg-gray-50 disabled:text-gray-500"
                required
                disabled={loading}
                autoComplete="email"
              />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent text-gray-900 bg-white placeholder:text-gray-400 disabled:bg-gray-50 disabled:text-gray-500"
                  required
                  disabled={loading}
